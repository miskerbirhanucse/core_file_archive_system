...
class LetterController extends Controller
{
    ...
    public function showCreatePage()
    {
        ...
        return view('letter.create_letter', ['projects' => $projects, 'departments' => $departments]);
    }
    ...
    public function storeLetter(Request $request)
    {
        ...
        $pathForOutgoingLetter = $departments . '/' . 'incomingLetter' . '/' . $projectName . '/' . $request->subject;
        ...
        InComingLetter::create([
            ...
            'ref_no' => $request->ref,
            'secretary_added_department' => $request->department_id,
    ...
    public function editLetter($id)
    {
        ...
        if ($letter->uploader()->first()->id == auth()->user()->id) {
            return view('letter.edit_letter', compact('letter', 'projects', 'departments'));
        }
...
//           $letter->departments()->attach($request->another_department_id);
    ...
    public function deleteArchive($id)
    {
        ...
        if ($inComingLetter) {
            return redirect()->route('letter.gm.cc')->with('success', 'Incoming Letter is deleted successfully');
        }
        return redirect()->route('letter.gm.cc')->with('error', 'unauthorize action you can\'t delete the Incoming Letter');
    }
}
