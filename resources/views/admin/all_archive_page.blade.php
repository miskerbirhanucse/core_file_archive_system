            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <!-- <div class="col-sm-2">
                            <a class="btn btn-primary text-wight" href="{{route('archive.report')}}">Generate Report</a>
                        </div> -->
                        <div class="col-sm-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('archive.delete',['id'=>$archive->id])}}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function fetch_archive_data(query = '') {
                ...
                $.ajax({
                    method: 'GET',
                    url: "{{route('archive.admin.search')}}",
                    data: {
                        'query': query,
                    },
                    dataType: 'json',
