                ...
                <form id="fileUploadForm" class="forms-sample" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select name="department_id" class="form-control bg-white text-dark" required>
                            <option class="form-control bg-white text-dark" value="">Select department</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control bg-white text-dark" name="subject" id="exampleTextarea1"
                                  placeholder="Enter subject" rows="4" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control bg-white text-dark" name="remark"
                                  id="exampleInputName1" placeholder=""></textarea>
                    </div>
                    <div class="form-group">
                        @error('letter_path')
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary mr-2">Upload Letter</button>
                    <!-- <div class="form-group ">
                    <div class="progress">
