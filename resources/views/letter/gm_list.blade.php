                    ...
                    <div class="row">
                        ...
                        <form id="incoming" action="{{route('incoming.search')}}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <select name="project_id" class="form-control bg-white border-info text-dark"
                                                required>4
                                            <option class="form-control bg-white text-dark" value="">Select project
                                            </option>
                                    ...
                                    <div class="col-md-3" style="margin-right: 30px;">
                                        <input class="border-info text-dark" name="subject"
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($letters as $letter)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('letter.detail',['id'=>$letter->id ])}}" class="edit"
                                           title="detail" data-toggle="tooltip"><i
                                                class="material-icons">&#xe5d4;</i></a>

                                        <a href="{{ route('letter.delete',['id'=>$letter->id ])}}" class="delete"
                                           title="Delete" data-toggle="tooltip"><i
                                                class="material-icons">&#xE872;</i></a>
                                        <a href="{{route('letter.download',['id'=>$letter->id])}}" class="download"
